...
| `Staking et récompenses` | `24%` | 2,400,000,000 |$6,000,000 | 
| `ICO` | `30%` | 3,000,000,000 |$7,500,000 | 
| `Exploitation minière` | `36%` | 3,600,000,000|$9,000,000  | 
...
•	Chaque Planet NFT a un prix de prévente de $0,25 et le prix de vente principal de $0,3.
...
•	Le propriétaire original/premier de la planète SPMT recevra une commission de 1 % sur chaque revente de sa planète SPMT NFT (ceci est uniquement réservé au premier propriétaire)
...
•	Le prix varie de $0,0001 à $0,0008.
